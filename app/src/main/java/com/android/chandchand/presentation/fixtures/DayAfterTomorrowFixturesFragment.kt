...
@AndroidEntryPoint
class DayAfterTomorrowFixturesFragment : Fragment(), FixturesController.HeaderClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getFixtures(getDateFromToday(2), WeekDay.DayAfterTomorrow)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.dayAfterTomorrowFixtures.observe(viewLifecycleOwner) {
