...
class ChandChandCallAdapterFactory @Inject constructor() : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        val type = getParameterUpperBound(0, responseType)

        return ChandChandCallAdapter<Any>(type)
    }
}
